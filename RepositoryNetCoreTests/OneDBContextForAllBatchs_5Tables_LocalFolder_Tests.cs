...
namespace DBCommon.Tests
{
    ...
    [TestClass()]
    public class OneDBContextForAllBatchs_5Tables_LocalFolder_Tests
    {
        ...
        public static void Init(TestContext _)
        {
            ...
            for (int i = 0; i < _dbContexts.Length; i++)
            {
                var filePath = Path.Combine(NetCorDBTests.Properties.Resources.Local,
                    $"{nameof(OneDBContextForAllBatchs_5Tables_LocalFolder_Tests)}{i}.sqlite");
        ...
        public void Add1Batch5000DataRowsTest(int batchId)
        {
            ...
            AddDataRowsHelper.Add1BatchDataRows(dbContext.Table1, batchId, 5000);
